...
#define	FLASHCFG_20MHZ_CPU	0		/*!< Flash accesses use 1 CPU clocks. Use for up to 20 MHz CPU clock*/
#define	FLASHCFG_40MHZ_CPU	1		/*!< Flash accesses use 2 CPU clocks. Use for up to 40 MHz CPU clock*/
#define	FLASHCFG_50MHZ_CPU	2		/*!< Flash accesses use 3 CPU clocks. Use for up to 50 MHz CPU clock*/
