...
__STATIC_INLINE void FLASH_SetFLASHAccess(uint32_t clks)
{
...
void SystemInit (void) {
  ...
  FLASH_SetFLASHAccess (FLASHCFG_50MHZ_CPU);
  ...
  LPC_IOCON->PIO0_3 = 1; // USB_VBUS
  LPC_IOCON->PIO0_6 = 1; // USB_CONNECT
